...
ThrFea_Tar = reshape(Features_Tar(3,:,HumanId,:,:),[30,6*14]);

FistFea_Rst = reshape(Features_Rst(1,:,HumanId,:,:),[30,6*14]);
SecFea_Rst = reshape(Features_Rst(2,:,HumanId,:,:),[30,6*14]);
ThrFea_Rst = reshape(Features_Rst(3,:,HumanId,:,:),[30,6*14]);

FistFea_Act = reshape(Features_Act(1,:,HumanId,:,:),[30,6*14]);
SecFea_Act = reshape(Features_Act(2,:,HumanId,:,:),[30,6*14]);
ThrFea_Act = reshape(Features_Act(3,:,HumanId,:,:),[30,6*14]);
...
%     hold on
%     scatter3(SecFea_Act(:,13*6+1+IMUindex*3),SecFea_Act(:,13*6+2+IMUindex*3),SecFea_Act(:,13*6+3+IMUindex*3),'gd');
%     scatter3(ThrFea_Act(:,13*6+1+IMUindex*3),ThrFea_Act(:,13*6+2+IMUindex*3),ThrFea_Act(:,13*6+3+IMUindex*3),'rs');
